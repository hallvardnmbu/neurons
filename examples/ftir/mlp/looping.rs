...
fn main() {
    ...
    vec!["REGRESSION", "CLASSIFICATION"]
        ...
        .for_each(|method| {
            ...
            network.loopback(2, 1, 1, Arc::new(|_loops| 1.0), false);
            network.set_accumulation(feedback::Accumulation::Mean, feedback::Accumulation::Mean);
            ...
            plot::loss(
                ...
                &format!("./output/ftir/mlp-{}-loop.png", method.to_lowercase()),
            );
